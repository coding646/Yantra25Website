...
export default function Heading(){
    return <div style={{zIndex:"10000", width:"99vw", fontSize:"3vw", top:"18vw"}} className="absolute flex justify-center text-white font-bold">
        <div className="flex flex-col items-center" style={{gap:"3vw"}}>
            ...
            <div className="font-medium bg-transparent hover:bg-orange-700 pl-5 pr-5 pt-3 pb-4 submitbutton " style={{borderRadius:"20px"}}>
               <a href="#" className="flex flex-row gap-2" style={{fontSize:"1.5vw"}}> Submit Your Idea <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-up-right mt-1" viewBox="0 0 16 16">
